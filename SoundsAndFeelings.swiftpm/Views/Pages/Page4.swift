...
struct InfoView4: View {
	var body: some View {
		VStack {
			...
			Text("\tIn this page you can't see the pure waves that make the resultant, instead, I've increased the range of notes you can play, they are tuned in equal temperament. This way, you can try to play some chords and tunes here!")
				.padding()
